...
export const ArtistFormModal: React.FC<ArtistFormModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (trimmedName.length < 2) {
      setError("Tên tác giả phải có ít nhất 2 ký tự");
      return;
    }

    if (trimmedName.length > 255) {
      setError("Tên tác giả không được vượt quá 255 ký tự");
      return;
    }
  ...
  const title = mode === "create" ? "Tạo tác giả mới" : "Sửa tên tác giả";
